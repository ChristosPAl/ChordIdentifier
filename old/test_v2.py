...
def label_chord(note_set):
    note_set_frozen = frozenset(note_set)
    return chord_dict.get(note_set_frozen, "Unknown Chord")
...
if __name__ == '__main__':
    script_dir = os.path.dirname(os.path.abspath(__file__))
    audio_file_path = os.path.join(script_dir, 'GeneratedChords', 'piano', 'Gm_piano.wav')
